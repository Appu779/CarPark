...
class MarkersPageState extends State<MarkersPage> {
  final controller = MapController(
    location: const LatLng(12.0977548009984, 75.5470405762744),
  );

  final markers = [
    const LatLng(12.096683124252502, 75.56026390137146),
    const LatLng(12.09742667802895, 75.5617253372382),
  ];

  void _gotoDefault() {
    controller.center = const LatLng(12.0977548009984, 75.5470405762744);
    setState(() {});
  }
      ...
      body: MapLayout(
        ...
        builder: (context, transformer) {
          ...
          final centerMarkerWidget =
              _buildMarkerWidget(centerLocation, Colors.green);
